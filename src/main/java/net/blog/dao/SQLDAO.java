...
import net.blog.dao.mapper.ArticleMapper;
import net.blog.dao.mapper.CommentMapper;
import net.blog.dao.mapper.ListMapper;
import net.blog.dao.mapper.MapCategoryMapper;
...
public final class SQLDAO {
    ...
    public Account findAccountByEmail(Connection c, String email) throws SQLException {
        return sql.query(c, "select * from account a where a.email = ?",
